...
public class SuperheroesMenu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_superheroes_menu);
    ...
    private void cuento01() {
        Intent intent = new Intent(this, CuentosSuperheroes.class);
