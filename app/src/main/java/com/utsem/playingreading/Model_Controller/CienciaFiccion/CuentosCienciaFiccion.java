...
public class CuentosCienciaFiccion extends AppCompatActivity {
    ...
    public void avance20() {
        ...
        if (cuentoSelecto >= 0 && cuentoSelecto < titulos.length) {
            ...
            imagenCuento.setImageResource(cienciaFiccionClass.getImagen());
    ...
    public void avance40() {
        ...
        if (cuentoSelecto >= 0 && cuentoSelecto < titulos.length) {
            ...
            //actividad 1
            imgAct01.setImageResource(cienciaFiccionClass.getImgAct01());
            btnLetra01.setText(cienciaFiccionClass.getBtnLetra01());
            btnLetra02.setText(cienciaFiccionClass.getBtnLetra02());
            btnLetra03.setText(cienciaFiccionClass.getBtnLetra03());
            btnLetra04.setText(cienciaFiccionClass.getBtnLetra04());
            btnLetra05.setText(cienciaFiccionClass.getBtnLetra05());
    ...
    public void avance60() {
        ...
        if (cuentoSelecto >= 0 && cuentoSelecto < titulos.length) {
            ...
            //actividad 2
            img01Act02.setImageResource(cienciaFiccionClass.getImg01Act02());
            img02Act02.setImageResource(cienciaFiccionClass.getImg02Act02());
            img03Act02.setImageResource(cienciaFiccionClass.getImg03Act02());
            img04Act02.setImageResource(cienciaFiccionClass.getImg04Act02());
            btn01Act02.setText(cienciaFiccionClass.getPalabra01());
            btn02Act02.setText(cienciaFiccionClass.getPalabra02());
            btn03Act02.setText(cienciaFiccionClass.getPalabra03());
            btn04Act02.setText(cienciaFiccionClass.getPalabra04());
    ...
    public void avance80() {
        ...
        if (cuentoSelecto >= 0 && cuentoSelecto < titulos.length) {
            ...
            //actividad 3: Amigos
            txtLetra01Act3.setText(cienciaFiccionClass.getLetra_Act3_01());
            txtLetra02Act3.setText(cienciaFiccionClass.getLetra_Act3_02());
            txtLetra03Act3.setText(cienciaFiccionClass.getLetra_Act3_03());
            txtLetra04Act3.setText(cienciaFiccionClass.getLetra_Act3_04());
            txtLetra05Act3.setText(cienciaFiccionClass.getLetra_Act3_05());
            txtLetra06Act3.setText(cienciaFiccionClass.getLetra_Act3_06());

            btnLetra01Act3.setText(cienciaFiccionClass.getBtn01Act03());
            btnLetra02Act3.setText(cienciaFiccionClass.getBtn02Act03());
            btnLetra03Act3.setText(cienciaFiccionClass.getBtn03Act03());
            btnLetra04Act3.setText(cienciaFiccionClass.getBtn04Act03());
    ...
    public void avance100() {
        ...
        if (cuentoSelecto >= 0 && cuentoSelecto < titulos.length) {
            ...
            //actividad 4
            txtPregunta01.setText(cienciaFiccionClass.getTxtPregunta01());
            rdbP011.setText(cienciaFiccionClass.getRdbP011());
            rdbP012.setText(cienciaFiccionClass.getRdbP012());
            rdbP013.setText(cienciaFiccionClass.getRdbP013());

            txtPregunta02.setText(cienciaFiccionClass.getTxtPregunta02());
            rdbP021.setText(cienciaFiccionClass.getRdbP021());
            rdbP022.setText(cienciaFiccionClass.getRdbP022());
            rdbP023.setText(cienciaFiccionClass.getRdbP023());

            txtPregunta03.setText(cienciaFiccionClass.getTxtPregunta03());
            rdbP031.setText(cienciaFiccionClass.getRdbP031());
            rdbP032.setText(cienciaFiccionClass.getRdbP032());
            rdbP033.setText(cienciaFiccionClass.getRdbP033());

            txtPregunta04.setText(cienciaFiccionClass.getTxtPregunta04());
            rdbP041.setText(cienciaFiccionClass.getRdbP041());
            rdbP042.setText(cienciaFiccionClass.getRdbP042());
            rdbP043.setText(cienciaFiccionClass.getRdbP043());

            txtPregunta05.setText(cienciaFiccionClass.getTxtPregunta05());
            rdbP051.setText(cienciaFiccionClass.getRdbP051());
            rdbP052.setText(cienciaFiccionClass.getRdbP052());
            rdbP053.setText(cienciaFiccionClass.getRdbP053());
    ...
    public void ponerLetra01(View v) {
        ...
        for(TextView letra : letras){
            if(letra.getText().toString().equals("__")){
                letra.setText(cienciaFiccionClass.getBtnLetra01());
    ...
    public void ponerLetra02(View v) {
        ...
        for(TextView letra : letras){
            if(letra.getText().toString().equals("__")){
                letra.setText(cienciaFiccionClass.getBtnLetra02());
    ...
    public void ponerLetra03(View v) {
        ...
        for(TextView letra : letras){
            if(letra.getText().toString().equals("__")){
                letra.setText(cienciaFiccionClass.getBtnLetra03());
    ...
    public void ponerLetra04(View v) {
        ...
        for(TextView letra : letras){
            if(letra.getText().toString().equals("__")){
                letra.setText(cienciaFiccionClass.getBtnLetra04());
    ...
    public void ponerLetra05(View v) {
        ...
        for(TextView letra : letras){
            if(letra.getText().toString().equals("__")){
                letra.setText(cienciaFiccionClass.getBtnLetra05());
    ...
    public void comprobarActividad01(View v){
        switch (cuentoSelecto) {
            case 0:
                if (txtLetra01.getText().toString().equals("C") && txtLetra02.getText().toString().equals("R") && txtLetra03.getText().toString().equals("E") && txtLetra04.getText().toString().equals("E") && txtLetra05.getText().toString().equals("R")) {
                ...
                break;
            case 1:
                if (txtLetra01.getText().toString().equals("M") && txtLetra02.getText().toString().equals("U") && txtLetra03.getText().toString().equals("N") && txtLetra04.getText().toString().equals("D") && txtLetra05.getText().toString().equals("O")) {
                    btnEvaluar01.setEnabled(false);
                    Toast.makeText(this, correcto, Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(this, incorrecto, Toast.LENGTH_SHORT).show();
                ...
                break;
            case 2:
                if (txtLetra01.getText().toString().equals("V") && txtLetra02.getText().toString().equals("I") && txtLetra03.getText().toString().equals("A") && txtLetra04.getText().toString().equals("J") && txtLetra05.getText().toString().equals("E")) {
                    btnEvaluar01.setEnabled(false);
                    Toast.makeText(this, correcto, Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(this, incorrecto, Toast.LENGTH_SHORT).show();
                ...
                break;
            case 3:
                if (txtLetra01.getText().toString().equals("P") && txtLetra02.getText().toString().equals("A") && txtLetra03.getText().toString().equals("P") && txtLetra04.getText().toString().equals("E") && txtLetra05.getText().toString().equals("L")) {
                    btnEvaluar01.setEnabled(false);
                    Toast.makeText(this, correcto, Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(this, incorrecto, Toast.LENGTH_SHORT).show();
    ...
    public void ponerLetra01Act03(View v) {
        ...
        for(TextView letra : letras){
            if(letra.getText().toString().equals("__")){
                letra.setText(cienciaFiccionClass.getBtn01Act03());
    ...
    public void ponerLetra02Act03(View v) {
        ...
        for(TextView letra : letras){
            if(letra.getText().toString().equals("__")){
                letra.setText(cienciaFiccionClass.getBtn02Act03());
    ...
    public void ponerLetra03Act03(View v) {
        ...
        for(TextView letra : letras){
            if(letra.getText().toString().equals("__")){
                letra.setText(cienciaFiccionClass.getBtn03Act03());
    ...
    public void ponerLetra04Act03(View v) {
        ...
        for(TextView letra : letras){
            if(letra.getText().toString().equals("__")){
                letra.setText(cienciaFiccionClass.getBtn04Act03());
    ...
    public void comprobarActividad03(View v){
        switch (cuentoSelecto){
            case 0:
                if(txtLetra01Act3.getText().toString().equals("C") && txtLetra02Act3.getText().toString().equals("O") &&  txtLetra03Act3.getText().toString().equals("N") && txtLetra04Act3.getText().toString().equals("F") && txtLetra05Act3.getText().toString().equals("I") && txtLetra06Act3.getText().toString().equals("A")){
            ...
            case 1:
                ...
                if(txtLetra01Act3.getText().toString().equals("D") && txtLetra02Act3.getText().toString().equals("O") &&  txtLetra03Act3.getText().toString().equals("R") && txtLetra04Act3.getText().toString().equals("M") && txtLetra05Act3.getText().toString().equals("I") && txtLetra06Act3.getText().toString().equals("R")){
                ...
                break;
            case 2:
                if(txtLetra01Act3.getText().toString().equals("E") && txtLetra02Act3.getText().toString().equals("Q") &&  txtLetra03Act3.getText().toString().equals("U") && txtLetra04Act3.getText().toString().equals("I") && txtLetra05Act3.getText().toString().equals("P") && txtLetra06Act3.getText().toString().equals("O")){
                    btnLetra01Act3.setEnabled(false);
                    btnLetra02Act3.setEnabled(false);
                    btnLetra03Act3.setEnabled(false);
                    btnLetra04Act3.setEnabled(false);
                ...
                break;
            case 3:
                if(txtLetra01Act3.getText().toString().equals("C") && txtLetra02Act3.getText().toString().equals("U") &&  txtLetra03Act3.getText().toString().equals("I") && txtLetra04Act3.getText().toString().equals("D") && txtLetra05Act3.getText().toString().equals("A") && txtLetra06Act3.getText().toString().equals("R")){
    ...
    public void comprobarPreguntas(View v){
        int[] respuestas = {cienciaFiccionClass.getPre011(), cienciaFiccionClass.getPre012(), cienciaFiccionClass.getPre013(), cienciaFiccionClass.getPre021(), cienciaFiccionClass.getPre022(), cienciaFiccionClass.getPre023(), cienciaFiccionClass.getPre031(), cienciaFiccionClass.getPre032(), cienciaFiccionClass.getPre033(), cienciaFiccionClass.getPre041(), cienciaFiccionClass.getPre042(), cienciaFiccionClass.getPre043(), cienciaFiccionClass.getPre051(), cienciaFiccionClass.getPre052(), cienciaFiccionClass.getPre053() };
    ...
    public CienciaFiccionClass getCienciaFiccionClass() {
        return cienciaFiccionClass;
    }

    public void setCienciaFiccionClass(CienciaFiccionClass cienciaFiccionClass) {
        this.cienciaFiccionClass = cienciaFiccionClass;
    }
