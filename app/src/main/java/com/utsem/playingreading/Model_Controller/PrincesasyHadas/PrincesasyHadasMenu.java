...
import com.utsem.playingreading.Model_Controller.Superheroes.CuentosSuperheroes;
import com.utsem.playingreading.R;

public class PrincesasyHadasMenu extends AppCompatActivity {
    private int valorCuentoSelecto;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_princesasy_hadas_menu);
    ...
    private void cuento01() {
        Intent intent = new Intent(this, CuentosPrincesasyHadas.class);
