...
public class CuentosMisterioyDetectives extends AppCompatActivity {
    ...
    MisteriosyDetectivesClass misteriosyDetectivesClass;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        misteriosyDetectivesClass = new MisteriosyDetectivesClass();
    ...
    public void colorActivity() {
        switch (cuentoSelecto) {
            case 0:
                scrCuento.setBackgroundColor(Color.parseColor("#E38B0F"));
                barraSuperior.setBackgroundColor(Color.parseColor("#BC7510"));
                barraInferior.setBackgroundColor(Color.parseColor("#BC7510"));
                break;
            case 1:
            ...
            case 2:
                ...
                barraSuperior.setBackgroundColor(Color.parseColor("#754E1C"));
                barraInferior.setBackgroundColor(Color.parseColor("#754E1C"));
                break;
            case 3:
                scrCuento.setBackgroundColor(Color.parseColor("#0DBF3A"));
                barraSuperior.setBackgroundColor(Color.parseColor("#107D2B"));
                barraInferior.setBackgroundColor(Color.parseColor("#107D2B"));
                break;
            case 4:
                scrCuento.setBackgroundColor(Color.parseColor("#06AAA3"));
                barraSuperior.setBackgroundColor(Color.parseColor("#0F7A75"));
                barraInferior.setBackgroundColor(Color.parseColor("#0F7A75"));
                break;
            default:
    ...
    public void avance20() {
        ...
        String[] titulos = misteriosyDetectivesClass.getTitulos();
        lyvAct01.setVisibility(View.GONE);
        atras.setEnabled(false);

        if (cuentoSelecto >= 0 && cuentoSelecto < titulos.length) {
            misteriosyDetectivesClass.setCuentoSelecto(cuentoSelecto);
            misteriosyDetectivesClass.avance20();
            String tituloCuento = misteriosyDetectivesClass.getTituloCuentoSelecto();
            titulo.setText(tituloCuento);
            parrafo.setText(misteriosyDetectivesClass.getParrafo());
            imagenCuento.setImageResource(misteriosyDetectivesClass.getImagen());
    ...
    public void avance40() {
        ...
        if (cuentoSelecto >= 0 && cuentoSelecto < titulos.length) {
            misteriosyDetectivesClass.setCuentoSelecto(cuentoSelecto);
            misteriosyDetectivesClass.avance40();
            parrafo.setText(misteriosyDetectivesClass.getParrafo());
            imagenCuento.setImageResource(misteriosyDetectivesClass.getImagen());

            //actividad 1
            imgAct01.setImageResource(misteriosyDetectivesClass.getImgAct01());
            btnLetra01.setText(misteriosyDetectivesClass.getBtnLetra01());
            btnLetra02.setText(misteriosyDetectivesClass.getBtnLetra02());
            btnLetra03.setText(misteriosyDetectivesClass.getBtnLetra03());
            btnLetra04.setText(misteriosyDetectivesClass.getBtnLetra04());
            btnLetra05.setText(misteriosyDetectivesClass.getBtnLetra05());
    ...
    public void avance60() {
        ...
        if (cuentoSelecto >= 0 && cuentoSelecto < titulos.length) {
            misteriosyDetectivesClass.setCuentoSelecto(cuentoSelecto);
            misteriosyDetectivesClass.avance60();
            parrafo.setText(misteriosyDetectivesClass.getParrafo());
            imagenCuento.setImageResource(misteriosyDetectivesClass.getImagen());

            //actividad 2
            img01Act02.setImageResource(misteriosyDetectivesClass.getImg01Act02());
            img02Act02.setImageResource(misteriosyDetectivesClass.getImg02Act02());
            img03Act02.setImageResource(misteriosyDetectivesClass.getImg03Act02());
            img04Act02.setImageResource(misteriosyDetectivesClass.getImg04Act02());
            btn01Act02.setText(misteriosyDetectivesClass.getPalabra01());
            btn02Act02.setText(misteriosyDetectivesClass.getPalabra02());
            btn03Act02.setText(misteriosyDetectivesClass.getPalabra03());
            btn04Act02.setText(misteriosyDetectivesClass.getPalabra04());
    ...
    public void avance80() {
        ...
        if (cuentoSelecto >= 0 && cuentoSelecto < titulos.length) {
            misteriosyDetectivesClass.setCuentoSelecto(cuentoSelecto);
            misteriosyDetectivesClass.avance80();
            parrafo.setText(misteriosyDetectivesClass.getParrafo());
            imagenCuento.setImageResource(misteriosyDetectivesClass.getImagen());

            //actividad 3: Amigos
            txtLetra01Act3.setText(misteriosyDetectivesClass.getLetra_Act3_01());
            txtLetra02Act3.setText(misteriosyDetectivesClass.getLetra_Act3_02());
            txtLetra03Act3.setText(misteriosyDetectivesClass.getLetra_Act3_03());
            txtLetra04Act3.setText(misteriosyDetectivesClass.getLetra_Act3_04());
            txtLetra05Act3.setText(misteriosyDetectivesClass.getLetra_Act3_05());
            txtLetra06Act3.setText(misteriosyDetectivesClass.getLetra_Act3_06());

            btnLetra01Act3.setText(misteriosyDetectivesClass.getBtn01Act03());
            btnLetra02Act3.setText(misteriosyDetectivesClass.getBtn02Act03());
            btnLetra03Act3.setText(misteriosyDetectivesClass.getBtn03Act03());
            btnLetra04Act3.setText(misteriosyDetectivesClass.getBtn04Act03());
    ...
    public void avance100() {
        ...
        if (cuentoSelecto >= 0 && cuentoSelecto < titulos.length) {
            misteriosyDetectivesClass.setCuentoSelecto(cuentoSelecto);
            misteriosyDetectivesClass.avance100();
            parrafo.setText(misteriosyDetectivesClass.getParrafo());
            imagenCuento.setImageResource(misteriosyDetectivesClass.getImagen());

            //actividad 4
            txtPregunta01.setText(misteriosyDetectivesClass.getTxtPregunta01());
            rdbP011.setText(misteriosyDetectivesClass.getRdbP011());
            rdbP012.setText(misteriosyDetectivesClass.getRdbP012());
            rdbP013.setText(misteriosyDetectivesClass.getRdbP013());

            txtPregunta02.setText(misteriosyDetectivesClass.getTxtPregunta02());
            rdbP021.setText(misteriosyDetectivesClass.getRdbP021());
            rdbP022.setText(misteriosyDetectivesClass.getRdbP022());
            rdbP023.setText(misteriosyDetectivesClass.getRdbP023());

            txtPregunta03.setText(misteriosyDetectivesClass.getTxtPregunta03());
            rdbP031.setText(misteriosyDetectivesClass.getRdbP031());
            rdbP032.setText(misteriosyDetectivesClass.getRdbP032());
            rdbP033.setText(misteriosyDetectivesClass.getRdbP033());

            txtPregunta04.setText(misteriosyDetectivesClass.getTxtPregunta04());
            rdbP041.setText(misteriosyDetectivesClass.getRdbP041());
            rdbP042.setText(misteriosyDetectivesClass.getRdbP042());
            rdbP043.setText(misteriosyDetectivesClass.getRdbP043());

            txtPregunta05.setText(misteriosyDetectivesClass.getTxtPregunta05());
            rdbP051.setText(misteriosyDetectivesClass.getRdbP051());
            rdbP052.setText(misteriosyDetectivesClass.getRdbP052());
            rdbP053.setText(misteriosyDetectivesClass.getRdbP053());
    ...
    public void escuchar(View v) {
        if (audio != null && audio.isPlaying()) {
            ...
            if (audio == null) {
                audio = MediaPlayer.create(this, misteriosyDetectivesClass.getAudio());
                if (audio != null) {
    ...
    public void ponerLetra01(View v) {
        ...
        for(TextView letra : letras){
            if(letra.getText().toString().equals("__")){
                letra.setText(misteriosyDetectivesClass.getBtnLetra01());
    ...
    public void ponerLetra02(View v) {
        ...
        for(TextView letra : letras){
            if(letra.getText().toString().equals("__")){
                letra.setText(misteriosyDetectivesClass.getBtnLetra02());
    ...
    public void ponerLetra03(View v) {
        ...
        for(TextView letra : letras){
            if(letra.getText().toString().equals("__")){
                letra.setText(misteriosyDetectivesClass.getBtnLetra03());
    ...
    public void ponerLetra04(View v) {
        ...
        for(TextView letra : letras){
            if(letra.getText().toString().equals("__")){
                letra.setText(misteriosyDetectivesClass.getBtnLetra04());
    ...
    public void ponerLetra05(View v) {
        ...
        for(TextView letra : letras){
            if(letra.getText().toString().equals("__")){
                letra.setText(misteriosyDetectivesClass.getBtnLetra05());
    ...
    public void comprobarActividad01(View v){
        switch (cuentoSelecto) {
            case 0:
                if (txtLetra01.getText().toString().equals("M") && txtLetra02.getText().toString().equals("U") && txtLetra03.getText().toString().equals("S") && txtLetra04.getText().toString().equals("E") && txtLetra05.getText().toString().equals("O")) {
                ...
                break;
            case 1:
                if (txtLetra01.getText().toString().equals("N") && txtLetra02.getText().toString().equals("O") && txtLetra03.getText().toString().equals("T") && txtLetra04.getText().toString().equals("A") && txtLetra05.getText().toString().equals("S")) {
                    btnEvaluar01.setEnabled(false);
                    Toast.makeText(this, correcto, Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(this, incorrecto, Toast.LENGTH_SHORT).show();
                ...
                break;
            case 2:
                if (txtLetra01.getText().toString().equals("P") && txtLetra02.getText().toString().equals("I") && txtLetra03.getText().toString().equals("S") && txtLetra04.getText().toString().equals("T") && txtLetra05.getText().toString().equals("A")) {
                    btnEvaluar01.setEnabled(false);
                    Toast.makeText(this, correcto, Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(this, incorrecto, Toast.LENGTH_SHORT).show();
                ...
                break;
            case 3:
                if (txtLetra01.getText().toString().equals("C") && txtLetra02.getText().toString().equals("A") && txtLetra03.getText().toString().equals("R") && txtLetra04.getText().toString().equals("T") && txtLetra05.getText().toString().equals("A")) {
                    btnEvaluar01.setEnabled(false);
                    Toast.makeText(this, correcto, Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(this, incorrecto, Toast.LENGTH_SHORT).show();
                ...
                break;
            case 4:
                if (txtLetra01.getText().toString().equals("P") && txtLetra02.getText().toString().equals("E") && txtLetra03.getText().toString().equals("R") && txtLetra04.getText().toString().equals("R") && txtLetra05.getText().toString().equals("O")) {
                    btnEvaluar01.setEnabled(false);
                    Toast.makeText(this, correcto, Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(this, incorrecto, Toast.LENGTH_SHORT).show();
    ...
    public void comprobarBtn01Act02(View v){
        switch (cuentoSelecto){
            case 0:
                Toast.makeText(this, "¡Correcto!. TI lo mejor de la UTsem", Toast.LENGTH_SHORT).show();
    ...
    public void ponerLetra01Act03(View v) {
        ...
        for(TextView letra : letras){
            if(letra.getText().toString().equals("__")){
                letra.setText(misteriosyDetectivesClass.getBtn01Act03());
    ...
    public void ponerLetra02Act03(View v) {
        ...
        for(TextView letra : letras){
            if(letra.getText().toString().equals("__")){
                letra.setText(misteriosyDetectivesClass.getBtn02Act03());
    ...
    public void ponerLetra03Act03(View v) {
        ...
        for(TextView letra : letras){
            if(letra.getText().toString().equals("__")){
                letra.setText(misteriosyDetectivesClass.getBtn03Act03());
    ...
    public void ponerLetra04Act03(View v) {
        ...
        for(TextView letra : letras){
            if(letra.getText().toString().equals("__")){
                letra.setText(misteriosyDetectivesClass.getBtn04Act03());
    ...
    public void comprobarActividad03(View v){
        switch (cuentoSelecto){
            case 0:
                if(txtLetra01Act3.getText().toString().equals("C") && txtLetra02Act3.getText().toString().equals("U") &&  txtLetra03Act3.getText().toString().equals("A") && txtLetra04Act3.getText().toString().equals("D") && txtLetra05Act3.getText().toString().equals("R") && txtLetra06Act3.getText().toString().equals("O")){
            ...
            case 1:
                ...
                if(txtLetra01Act3.getText().toString().equals("V") && txtLetra02Act3.getText().toString().equals("E") &&  txtLetra03Act3.getText().toString().equals("R") && txtLetra04Act3.getText().toString().equals("D") && txtLetra05Act3.getText().toString().equals("A") && txtLetra06Act3.getText().toString().equals("D")){
                ...
                break;
            case 2:
                if(txtLetra01Act3.getText().toString().equals("M") && txtLetra02Act3.getText().toString().equals("U") &&  txtLetra03Act3.getText().toString().equals("N") && txtLetra04Act3.getText().toString().equals("D") && txtLetra05Act3.getText().toString().equals("O") && txtLetra06Act3.getText().toString().equals("S")){
                    btnLetra01Act3.setEnabled(false);
                    btnLetra02Act3.setEnabled(false);
                    btnLetra03Act3.setEnabled(false);
                    btnLetra04Act3.setEnabled(false);
                ...
                break;
            case 3:
                if(txtLetra01Act3.getText().toString().equals("T") && txtLetra02Act3.getText().toString().equals("E") &&  txtLetra03Act3.getText().toString().equals("S") && txtLetra04Act3.getText().toString().equals("O") && txtLetra05Act3.getText().toString().equals("R") && txtLetra06Act3.getText().toString().equals("O")){
                ...
                break;
            case 4:
                if(txtLetra01Act3.getText().toString().equals("A") && txtLetra02Act3.getText().toString().equals("Y") &&  txtLetra03Act3.getText().toString().equals("U") && txtLetra04Act3.getText().toString().equals("D") && txtLetra05Act3.getText().toString().equals("A") && txtLetra06Act3.getText().toString().equals("R")){
    ...
    public void comprobarPreguntas(View v){
        int[] respuestas = {misteriosyDetectivesClass.getPre011(), misteriosyDetectivesClass.getPre012(), misteriosyDetectivesClass.getPre013(), misteriosyDetectivesClass.getPre021(), misteriosyDetectivesClass.getPre022(), misteriosyDetectivesClass.getPre023(), misteriosyDetectivesClass.getPre031(), misteriosyDetectivesClass.getPre032(), misteriosyDetectivesClass.getPre033(), misteriosyDetectivesClass.getPre041(), misteriosyDetectivesClass.getPre042(), misteriosyDetectivesClass.getPre043(), misteriosyDetectivesClass.getPre051(), misteriosyDetectivesClass.getPre052(), misteriosyDetectivesClass.getPre053() };
    ...
    public MisteriosyDetectivesClass getMisteriosyDetectivesClass() {
        return misteriosyDetectivesClass;
    }

    public void setMisteriosyDetectivesClass(MisteriosyDetectivesClass misteriosyDetectivesClass) {
        this.misteriosyDetectivesClass = misteriosyDetectivesClass;
    }
